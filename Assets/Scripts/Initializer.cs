...
public class Initializer : MonoBehaviour
{
    ...
    [SerializeField, NotNull] private GameObject infoPanel, mapBackground;
    [SerializeField, NotNull] private ChangeWindowButtonHandler hndlr;

    void Awake()
    {
        DataLinks.Initialize();
    ...
    private void Start() => hndlr.ChangeWindow(type: ChangeWindowButtonHandler.WindowType.Basic);
}
