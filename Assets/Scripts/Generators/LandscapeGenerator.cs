...
public class LandscapeGenerator : MonoBehaviour
{
    ...
    /// 
    /// Ћќ√» ј:
    ///    - ќблака имеют фиксированный scale, указанный в константах.
    ///    - ќблака генерируютс€ на тех же высотах, что и самолеты (использу€ массив из класса PlaneCoordinatesCalculator скрипта PlaneGenerator.cs)
    /// </summary>
    public class CloudsGenerator
    {
        private const float SCALE = 0.11f;  // по всем ос€м
